...
--[[----------------------------------------------------------
    ...
    local Changes = {
			...
			[1] = {
				"General Changes",
				"Update addon for ESO v2.7 API compatibility.",
			},

			[2] = {
				"Buff Tracking",
				"Added a button for refreshing the party to avoid the auto-refresh issue.",
			},

			[3] = {
				"Homestead",
				"A group effort was put into the homestead addition. Demiknight  / Rhyono  / Casterial"
				},

			[4] = {
				"Going Forward",
				"The addon has not seen any update by Philgo, or Astrops for quite sometime, so keep up with the new FTC on esoUI"
				},
			}
		...
		welcome:AddText("|c|r")	
		welcome:AddText("If you have any feedback, bug reports, or other questions about Foundry Tactical Combat please contact |cCC6600@Casterial|r or |cCC6600@Rhyono|r on the North American PC megaserver. Thank you for using the FTC addon and for your support!")
	end