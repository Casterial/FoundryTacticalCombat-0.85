...
ZO_CreateStringId("FTC_Menu_FRWidthDesc",   "Ändert die Höhe des Schlachtzugsfensters. [Standard: "..FTC.Defaults.RaidWidth.."]")

ZO_CreateStringId("FTC_Menu_FRHeight",      "Schlachtzugsfenster Breite")
ZO_CreateStringId("FTC_Menu_FRHeightDesc",  "Ändert die Breite des Schlachtzugsfensters. [Standard: "..FTC.Defaults.RaidHeight.."]")
